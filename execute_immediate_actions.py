...
def execute_step_1():
    ...
    process = run_command("python monitor_live_system.py --dashboard > monitor_system.log 2>&1 &", background=True)
...
def start_trading_system():
    ...
    run_command("python run_new_listings_radar.py --scan > new_listings_radar.log 2>&1 &", background=True)
