...
2. `run_global_macro_demo.py` - Demo script showing global macro signals in action
3. `integrate_global_macro.py` - Integration script showing your complete signal portfolio
