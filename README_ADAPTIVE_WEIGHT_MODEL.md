...
2. **Signal Data Collector**: Gathers and preprocesses all 15 signal outputs for model input
3. **TensorFlow Neural Network**: Learns optimal weights for different market conditions
4. **Market Regime Integrator**: Connects regime detection with weight optimization
