...
1. Run the trading engine with regime detection

1. Generate visualizations of regime detection and trading performance

1. Save performance statistics to `market_regime_stats.json`
