...
2. Runs backtests on the entire dataset and calculates performance metrics by regime
3. Runs separate backtests specifically on bull, bear, and sideways market periods
...
2. Include data covering different market regimes
