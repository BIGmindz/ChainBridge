...
class NewListingsDashboard:
    ...
    def plot_backtest_results(self):
        ...
        axes[1].axvline(x=avg_return, color='r', linestyle='--', 
    ...
    def print_listing_summary(self):
        ...
        for listing in recent_listings:
            ...
            if "entry_strategy" in listing:
                print(f"   Entry: {listing['entry_strategy']['type'] if isinstance(listing['entry_strategy'], dict) else listing['entry_strategy']}")
