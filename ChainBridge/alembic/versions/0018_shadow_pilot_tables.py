...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.ForeignKey("shadow_pilot_runs.run_id"),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_shadow_pilot_shipments_customer_segment",
        "shadow_pilot_shipments",
        ["customer_segment"],
    )
    op.create_index(
        "idx_shadow_pilot_shipments_shipment_id",
        "shadow_pilot_shipments",
        ["shipment_id"],
    )
...
def downgrade() -> None:
    op.drop_index(
        "idx_shadow_pilot_shipments_customer_segment",
        table_name="shadow_pilot_shipments",
    )
