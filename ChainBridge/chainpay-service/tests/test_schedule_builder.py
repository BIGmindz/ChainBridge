...
class TestLowRiskScheduleBuilding:
    ...
    def test_low_risk_schedule_sum_to_one(self):
...
class TestMediumRiskScheduleBuilding:
    ...
    def test_medium_risk_schedule_items_count(self):
        """MEDIUM-risk schedule should have 3 items."""
        items = build_default_schedule(RiskTierSchedule.MEDIUM)
        assert len(items) == 3

    def test_medium_risk_schedule_percentages(self):
    ...
    def test_medium_risk_schedule_sum_to_one(self):
        """MEDIUM-risk schedule percentages should sum to 1.0."""
        items = build_default_schedule(RiskTierSchedule.MEDIUM)
        total = sum(item["percentage"] for item in items)
        assert abs(total - 1.0) < 0.001

    def test_medium_risk_schedule_sequence_order(self):
...
class TestHighRiskScheduleBuilding:
    ...
    def test_high_risk_schedule_items_count(self):
        """HIGH-risk schedule should have 3 items."""
        items = build_default_schedule(RiskTierSchedule.HIGH)
        assert len(items) == 3

    def test_high_risk_schedule_percentages(self):
    ...
    def test_high_risk_schedule_sum_to_one(self):
        """HIGH-risk schedule percentages should sum to 1.0."""
        items = build_default_schedule(RiskTierSchedule.HIGH)
        total = sum(item["percentage"] for item in items)
        assert abs(total - 1.0) < 0.001

    def test_high_risk_schedule_sequence_order(self):
...
class TestScheduleDifferentiationByRiskTier:
    ...
    def test_low_vs_medium_risk_different_schedules(self):
...
class TestScheduleStructureValidation:
    ...
    def test_schedule_item_has_required_keys(self):
...
class TestScheduleConsistency:
    ...
    def test_low_risk_schedule_reproducible(self):
    ...
    def test_medium_risk_schedule_reproducible(self):
    ...
    def test_high_risk_schedule_reproducible(self):
