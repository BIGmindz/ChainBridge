...
| File | Purpose |
|------|---------|
| `PROJECT_CHECKLIST.md` | Master checklist with all M01–M04 tasks |
...
- **Project Checklist:** `PROJECT_CHECKLIST.md` – Comprehensive task tracking
...
- **Architecture:** `architecture.md` – System design with Mermaid diagram
