...
def run_comprehensive_demo():
    ...
    signal_modules = [
        ...
        (
            "modules.bollinger_bands_module",
            "Bollinger Bands Module",
            {"period": 20, "std_multiplier": 2.0},
        ),
        (
            "modules.volume_profile_module",
        ...
        (
            "modules.multi_signal_aggregator_module",
    ...
    scenarios = [
        ...
        (
            ...
            47000,
            0.008,
            "Range-bound movement with low volatility",
        ),
    ]
    ...
    if scenario_results:
        ...
        for scenario_name, result in scenario_results.items():
            print(
                f"{scenario_name:15} │ {result['final_signal']:6} │ {result['confidence']:5.2f} │ "
