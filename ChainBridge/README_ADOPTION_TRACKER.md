...
1. Initialize the module: `adoption_tracker = AdoptionTrackerModule()`

1. Process data to get signals: `result = adoption_tracker.process()`

1. Access the signal: `signal = result['signal']  # 'BUY', 'SELL', or 'HOLD'`

1. Get confidence: `confidence = result['confidence']  # 0.0 to 1.0`

1. Read the reasoning: `reasoning = result['reasoning']`
