...
class TestEnhancedRegimeModel(unittest.TestCase):
    ...
    def test_sample_data_generation(self):
        ...
        expected_features = [
            ...
            'volatility_24h', 'trend_strength', 'momentum_rsi',
            'price_momentum', 'volume_price_trend', 'bb_squeeze'
        ]
    ...
    def test_prediction(self):
        ...
        test_features = pd.DataFrame([{
            'rsi_14': 65.0, 'macd': 0.02, 'macd_signal': 0.015, 'macd_hist': 0.005,
            'bb_upper': 52000, 'bb_middle': 50000, 'bb_lower': 48000,
            'bb_width': 4000, 'bb_position': 0.75, 'volume_ratio': 1.5,
            'price_change_1h': 0.01, 'price_change_24h': 0.03,
            'volatility_24h': 0.20, 'trend_strength': 0.7,
            'momentum_rsi': 68.0, 'price_momentum': 0.15,
            'volume_price_trend': 0.045, 'bb_squeeze': 0
        }])
    ...
    def test_single_prediction(self):
        ...
        # Single prediction
        feature_dict = {
            'rsi_14': 30.0, 'macd': -0.02, 'macd_signal': -0.015, 'macd_hist': -0.005,
            'bb_upper': 52000, 'bb_middle': 50000, 'bb_lower': 48000,
            'bb_width': 4000, 'bb_position': 0.25, 'volume_ratio': 2.0,
            'price_change_1h': -0.01, 'price_change_24h': -0.05,
            'volatility_24h': 0.30, 'trend_strength': -0.8,
            'momentum_rsi': 28.0, 'price_momentum': -0.17,
            'volume_price_trend': -0.1, 'bb_squeeze': 0
        }
    ...
    def test_model_save_load(self):
        ...
        feature_dict = {
            ...
            'bb_upper': 52000, 'bb_middle': 50000, 'bb_lower': 48000,
            'bb_width': 4000, 'bb_position': 0.5, 'volume_ratio': 1.2,
            'price_change_1h': 0.005, 'price_change_24h': 0.01,
            'volatility_24h': 0.15, 'trend_strength': 0.1,
            'momentum_rsi': 52.0, 'price_momentum': 0.07,
            'volume_price_trend': 0.012, 'bb_squeeze': 1
        }
