...
class KrakenPaperLiveBot:
    ...
    def calculate_position_size(self, symbol: str, signal_confidence: float, 
                              volatility: float, correlation_adj: float = 1.0) -> float:
        """
    ...
    def open_position(self, symbol: str, side: str, signal_confidence: float,
        ...
        if position_size <= 0:
            return {'success': False, 'error': 'Insufficient capital or position size too small'}
    ...
    def get_performance_dashboard(self) -> Dict[str, Any]:
        ...
        dashboard = {
            ...
            'account': {
                ...
                'total_return_pct': ((portfolio_value - self.budget_manager.initial_capital) / 
                                   self.budget_manager.initial_capital * 100)
            },
            'positions': {
