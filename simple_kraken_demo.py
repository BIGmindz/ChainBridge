...
class MockPosition:
    def __init__(self, position_id, symbol, side, entry_price, quantity, stop_loss=None, take_profit=None):
        self.id = position_id
        self.symbol = symbol
        self.side = side
...
class SimplePaperTradingBot:
    ...
    def open_position(self, symbol, side, signal_confidence, volatility=0.03, 
                     stop_loss_pct=0.03, take_profit_pct=0.06, tags=None):
