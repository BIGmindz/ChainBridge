...
# --- Page Configuration ---
st.set_page_config(page_title="BensonBot Strategy Backtest Comparison", layout="wide")
...
st.markdown(
    "A consolidated view of all strategy backtests. Use this hub to compare performance and identify top candidates for live deployment."
)
st.markdown("---")
