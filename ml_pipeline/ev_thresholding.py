...
class EVThresholdOptimizer:
    ...
    def optimize_threshold(self,
                          ...
                          return_curve: bool = False) -> Tuple[ThresholdResult, Optional[pd.DataFrame]]:
        """
    ...
    def _evaluate_threshold(self,
                           y_true: pd.Series,
                           y_prob: pd.Series,
                           threshold: float) -> Optional[ThresholdResult]:
        """
    ...
    def _calculate_returns_with_costs(self,
                                     y_true: pd.Series,
...
def find_multiple_thresholds(y_true: pd.Series,
                           y_prob: pd.Series,
                           n_thresholds: int = 3,
                           **kwargs) -> List[ThresholdResult]:
    """
...
def plot_threshold_curve(curve_data: pd.DataFrame,
