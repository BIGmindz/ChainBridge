...
def demonstrate_model_loading_and_prediction():
    ...
    model_name = 'enhanced' if 'enhanced' in available_models else (
        'original' if 'original' in available_models else None
    )
...
def create_live_market_simulation():
    ...
    print(f"Date         │ Regime   │ Conf │ RSI │ MACD  │ Trend │ Vol")
    print("-" * 60)
    ...
    for date in dates:
        ...
        print(f"{date_str} │ {regime_emoji}{regime:<7} │{confidence:.2f} │{features['rsi_14']:4.0f}│"
