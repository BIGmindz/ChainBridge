...
class AdoptionTrackerModule(Module):
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.regions = {
            "CENTRAL_SOUTHERN_ASIA": {"weight": 0.22, "key_countries": ["IND", "PAK", "VNM"]},
            "LATIN_AMERICA": {"weight": 0.18, "key_countries": ["BRA", "ARG", "MEX", "COL", "VEN"]},
            "MIDDLE_EAST_NORTH_AFRICA": {"weight": 0.12, "key_countries": ["TUR", "EGY", "MAR"]},
            ...
            "SUB_SAHARAN_AFRICA": {"weight": 0.15, "key_countries": ["NGA", "KEN", "ZAF"]}
        }
        
        # Countries with high growth potential
        self.high_growth_countries = ["VNM", "UKR", "ARG", "BRA", "IND", "NGA", "PHL", "TUR"]
    ...
    def _generate_simulated_adoption_data(self) -> Dict[str, Any]:
        ...
        base_year_data = {
            "CENTRAL_SOUTHERN_ASIA": {"index": 0.58, "rank": 1, "countries": {
                "IND": {"index": 0.66, "rank": 1},
                "PAK": {"index": 0.41, "rank": 8},
                "VNM": {"index": 0.53, "rank": 5}
            }},
            "LATIN_AMERICA": {"index": 0.51, "rank": 2, "countries": {
