...
class MACDModule(Module):
    ...
    def calculate_macd(self, prices: pd.Series, fast_period: int, 
    ...
    def generate_signal(self, macd_current: float, signal_current: float, 
                       histogram_current: float, macd_prev: float, 
                       signal_prev: float, histogram_prev: float) -> Tuple[str, float, str]:
        """
    ...
    def process(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            signal, confidence, strength = self.generate_signal(
                macd_current, signal_current, histogram_current,
                macd_prev, signal_prev, histogram_prev
            )
