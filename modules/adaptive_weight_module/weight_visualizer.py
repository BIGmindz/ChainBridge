...
class AdaptiveWeightVisualizer:
    ...
    def plot_regime_transitions(self, transition_matrix: Dict[str, Dict[str, float]], 
                                title: str = "Regime Transition Probabilities") -> str:
        """
        ...
        sns.heatmap(df, annot=True, cmap="YlGnBu", vmin=0, vmax=1, fmt=".2f", cbar_kws={'label': 'Probability'})
    ...
    def plot_performance_by_regime(self, performance_data: Dict[str, Dict[str, float]], 
                                   metric: str = "win_rate", 
                                   title: str = "Trading Performance by Market Regime") -> str:
        """
    ...
    def plot_weight_optimization(self, weight_history: List[Dict[str, Any]], 
                                title: str = "Signal Weight Optimization Over Time") -> str:
        """
        ...
        # Add regime legend
        regime_patches = [plt.Rectangle((0, 0), 1, 1, color=color, alpha=0.3) 
    ...
    def plot_signal_importance(self, signal_weights: Dict[str, float], 
                              title: str = "Signal Importance for Current Market Regime") -> str:
        """
