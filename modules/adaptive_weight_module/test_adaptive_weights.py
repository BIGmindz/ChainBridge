...
class AdaptiveWeightTester:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.results_dir = os.path.join(
            self.config.get("results_dir", "test_results"),
    ...
    def _generate_price_scenarios(self) -> None:
        ...
        for scenario in self.sample_data.values():
            ...
            volumes = [
                base_volume * (1 + 2 * abs(change) / base_price + np.random.normal(0, 0.1))
    ...
    def _visualize_weight_optimization(self, results: Dict[str, Any]) -> str:
        ...
        layers = ["LAYER_1_TECHNICAL", "LAYER_2_LOGISTICS", "LAYER_3_GLOBAL_MACRO", "LAYER_4_ADOPTION"]
...
def main():
    ...
    print(f"Correct Classifications: {results['regime_detection']['correct_classifications']}/{results['regime_detection']['scenarios_tested']}")
