...
class AdaptiveWeightModule(Module):
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.signal_layers = {
            ...
            "LAYER_2_LOGISTICS": ["Port_Congestion", "Diesel", "Supply_Chain", "Container"],
            "LAYER_3_GLOBAL_MACRO": ["Inflation", "Regulatory", "Remittance", "CBDC", "FATF"],
        ...
        self.regime_features = self.config.get("regime_features", [
    ...
    def _build_weight_model(self) -> keras.Model:
        ...
        # Create model
        model = Model(
            inputs=[signal_input, regime_input, market_input],
            outputs=outputs
        )
...
if __name__ == "__main__":
    ...
    sample_data = {
        ...
        "market_data": {
            "price_history": [
                {"time": "2025-09-10T00:00:00", "open": 45000, "high": 46000, "low": 44800, "close": 45900},
                {"time": "2025-09-11T00:00:00", "open": 45900, "high": 47000, "low": 45500, "close": 46800},
                {"time": "2025-09-12T00:00:00", "open": 46800, "high": 48000, "low": 46500, "close": 47500},
                # ... more price data
            ],
            "rsi": 65,
            "bb_width": 0.15
