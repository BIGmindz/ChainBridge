...
class GlobalMacroModule:
    ...
    def __init__(self):
        ...
        self.key_countries = {
            'IND': {'rank': 1, 'weight': 0.18, 'type': 'adoption_leader', 'trend': 'increasing'},
            'USA': {'rank': 2, 'weight': 0.12, 'type': 'institutional', 'trend': 'stable'},
            'BRA': {'rank': 5, 'weight': 0.10, 'type': 'inflation_hedge', 'trend': 'increasing'},
            'ARG': {'rank': 20, 'weight': 0.08, 'type': 'currency_crisis', 'trend': 'increasing'},
            'VEN': {'rank': 18, 'weight': 0.06, 'type': 'hyperinflation', 'trend': 'stable'},
            'SLV': {'rank': 50, 'weight': 0.06, 'type': 'btc_legal_tender', 'trend': 'stable'},
            'JPN': {'rank': 19, 'weight': 0.08, 'type': 'institutional', 'trend': 'increasing'},
            'NGA': {'rank': 6, 'weight': 0.08, 'type': 'remittance', 'trend': 'increasing'},
            # New countries added for enhanced tracking
            'KOR': {'rank': 3, 'weight': 0.06, 'type': 'tech_adoption', 'trend': 'increasing'},
            'VNM': {'rank': 4, 'weight': 0.04, 'type': 'emerging_market', 'trend': 'rapid_increase'},
            'UKR': {'rank': 8, 'weight': 0.04, 'type': 'conflict_region', 'trend': 'increasing'},
            'TUR': {'rank': 12, 'weight': 0.04, 'type': 'currency_devaluation', 'trend': 'increasing'},
            'ZAF': {'rank': 7, 'weight': 0.06, 'type': 'emerging_market', 'trend': 'stable'}
        }
    ...
    def _get_adoption_signal(self) -> Dict:
        ...
        try:
            ...
            country_adoption = {
                ...
                'KOR': {'growth': 0.52, 'penetration': 0.32, 'institutional': 0.45}, # New
                'VNM': {'growth': 0.72, 'penetration': 0.18, 'institutional': 0.12}, # New
                'UKR': {'growth': 0.65, 'penetration': 0.25, 'institutional': 0.10}, # New
                'TUR': {'growth': 0.62, 'penetration': 0.26, 'institutional': 0.15}, # New
                'ZAF': {'growth': 0.58, 'penetration': 0.20, 'institutional': 0.18}  # New
            }
